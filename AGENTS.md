...
**Always use `C:\Users\Leon\AppData\Local\Programs\Python\Python312\python.exe`** — this is the only install with
...
- **PowerShell**: use `run.bat <script.py>` or `& "C:\Users\Leon\AppData\Local\Programs\Python\Python312\python.exe" <script.py>`
